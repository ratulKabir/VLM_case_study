...
model = YOLO("yolov8n.pt").to(device)  # Move model to MPS

# Train the model on your labeled data (few-shot learning)
model.train(data="./visual_detection/dataset.yaml", epochs=50, batch=16, device=device)

# Save the fine-tuned model
model.save("./visual_detection/saved_models/yolov8n_custom_50epochs.pt")
